    ...
    public class AuthService : IAuthService
    {
        ...
        public async Task<string> CreateTokenAsync(AppUser user, UserManager<AppUser> userManager)
        {
            ...
            var token = new JwtSecurityToken(
                ...
                issuer: _configuration["Jwt:ValidIssuer"],     //Register Claims
                expires: DateTime.Now.AddDays(double.Parse(_configuration["Jwt:DurationDays"])), //Register Claims
                claims : authClaims,  //Private claims
                signingCredentials : new SigningCredentials(authKey,SecurityAlgorithms.HmacSha256Signature)
                //Secret key , Security algorithm                
                );
